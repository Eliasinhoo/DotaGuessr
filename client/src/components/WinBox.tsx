...
import { AppDispatch, resetGame } from "../store";
...
export default function WinBox() {
    ...
    if(win === null){
        ...
        return win ? <div className="z-10 flex items-center justify-center"><div className="flex space-x-4 justify-center items-center bg-back border-2 border-black rounded-md p-5 space-y-1 text-prim font-semibold w-[300px] z-10">You win</div></div >: 
